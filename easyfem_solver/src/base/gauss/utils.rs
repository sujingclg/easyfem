...
pub fn gauss_1d_matrix(deg: usize) -> MatrixXx2<f64> {
...
pub fn gauss_2d_matrix(deg: usize) -> MatrixXx3<f64> {
...
pub fn gauss_3d_matrix(deg: usize) -> MatrixXx4<f64> {
...
mod tests {
    ...
    #[test]
    fn gauss_1d_test() {
        let matrix = gauss_1d_matrix(2);
        println!("{}", matrix);
    }

    #[test]
    fn gauss_2d_test() {
        let matrix = gauss_2d_matrix(2);
        println!("{}", matrix);
    }

    #[test]
    fn gauss_3d_test() {
        let matrix = gauss_3d_matrix(2);
        println!("{}", matrix);
    }
}
